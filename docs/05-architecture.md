...
Фаза 3 добавила 65 блоков V1, окна 11 проб, waterfall, transient-временную шкалу, PWA,
share-link, экспорт PNG/Markdown, 10 продвинутых заданий и туториал.

* Оставшиеся transient-сценарии и аномалии A3/A7/A8 — см. [02-simulation.md](02-simulation.md) §15.3.
...
* Специальные режимы «Интервью», «Инцидент» и «Гольф» относятся к фазе 4.
