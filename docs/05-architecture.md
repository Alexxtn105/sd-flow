...
* Сценарий `split-brain` — см. [02-simulation.md](02-simulation.md) §15.3, там же полный перечень
  нереализованного в модели; рабочий список по требованиям PRD — [06-backlog.md](06-backlog.md).
